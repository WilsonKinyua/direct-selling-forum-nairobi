                ...
                <tbody>
                    @foreach($contactUss as $key => $contactUs)
                        <tr data-entry-id="{{ $contactUs->id }}">
                            ...
                            <td>
                                @can('contact_us_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.contact-uss.show', $contactUs->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('contact_us_delete')
                                    <form action="{{ route('admin.contact-uss.destroy', $contactUs->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
